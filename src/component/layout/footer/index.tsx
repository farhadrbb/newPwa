...
const Footer = memo((props: any) => {
    ...
    let classToolMenu = 'bg-cyan-50 w-10 h-10 flex justify-center items-center absolute -top-[22%] rounded-full shadow-[0_0_10px_3px_rgba(0,0,0,0.5)] shadow-gray-400 dark:shadow-darkMode-black'
