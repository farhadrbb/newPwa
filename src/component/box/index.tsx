...
const Box = memo((props: IProps) => {
    ...
    const boxClass = "bg-white w-full pt-2 rounded-[15px] flex flex-col dark:bg-darkMode-grayDark shadow-2xl shadow-gray-500 dark:shadow-gray-900 overflow-y-auto min-h-[10vh] max-h-[70vh]"
